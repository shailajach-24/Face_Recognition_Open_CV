...
test_img=cv2.imread(r'GIVE PATH HERE\8.jpg')  #Give path to the image which you want to test
...
name={0:"SAI VARA PRASAD",1:"SHARATH CHANDRA",2:"SAI KUMAR",3:"ANJAN"}    #Change names accordingly. If you want to recognize only one person then write:- name={0:"name"} thats all. Dont write for id number 1.
